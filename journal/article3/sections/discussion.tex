...
capture what a compositional refinement would, on any of the five
libraries we measured. Two structural shapes are out of reach by
...
Vavr, and a substantial third on jOOL; disjunctive shapes are
...
The second pass adds 42{,}370 \emph{new} clauses on top of an
...
clearly worth integrating: an extra 44 seconds total across all five
libraries for an average of 35.6\% of methods receiving refined
