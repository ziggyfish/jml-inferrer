...
byte-identical metric output (we verified across five libraries).
...
The measurement is on five libraries (Commons Lang, Commons IO,
...
across all five (24--44\% of methods refined; branch-conditional
