...
We implement the pass as a Java class, \texttt{com.jml.\allowbreak{}inferrer.\allowbreak{}analysis.\allowbreak{}CompositionalAnalyzer}, sitting next to the existing \texttt{InterproceduralAnalyzer} in the inferrer's module. The class is 453 lines, with a small companion
\texttt{EntryScopeFilter} (93 lines) that enforces entry-state
well-formedness of lifted clauses (Section~\ref{sec:empirical}); both
depend only on the inferrer's existing model (\texttt{MethodSpecification},
