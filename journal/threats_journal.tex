...
We used Google's Gemini 2.0. Results may differ with other models (GPT-4, Claude, open-source models such as CodeGen~\cite{nijkamp2023codegen}). The JML specification format is standard and should transfer, but absolute test counts and mutation scores may vary. Recent comparisons of LLM-based test generation~\cite{schafer2023adaptive, yuan2024chatunitest} suggest qualitative findings often generalize across models.
...
Mutation testing measures fault detection capability but has limitations~\cite{papadakis2019mutation}:
\begin{itemize}
...
We used PiTest's default operators, which have been validated in prior research~\cite{coles2016pitest, hamlet1994random}, and excluded trivially equivalent mutants.
