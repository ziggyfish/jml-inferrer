...
\FOR{each conditional field assignment \texttt{this.f = $e$} under path $\pi$}
    \STATE $Post \gets Post \cup \{\pi \Longrightarrow \texttt{this.f == $e[\textbackslash old/\cdot]$}\}$
\ENDFOR
