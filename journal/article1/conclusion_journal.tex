...
\begin{enumerate}
    \item \emph{Specifications substantially improve test quality.} LLM-generated tests guided by specifications produce 272\% more tests and achieve a mutation score 40.7~pp higher than signature-only baselines ($p < 0.001$, $d = 2.41$).
