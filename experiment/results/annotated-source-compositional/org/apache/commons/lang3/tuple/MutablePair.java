...
public class MutablePair<L, R> extends Pair<L, R> {
     ...
     */
    @com.jml.inferrer.annotations.Requires("pair != null")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
     ...
     * @since 3.13.0
     */
    @com.jml.inferrer.annotations.Requires("left != null")
    @com.jml.inferrer.annotations.Requires("right != null")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == of(Objects.requireNonNull(left, \"left\"), Objects.requireNonNull(right, \"right\"))")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
    ...
    @com.jml.inferrer.annotations.Requires("right != null")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == of(Objects.requireNonNull(pair, \"pair\"))")
    @com.jml.inferrer.annotations.Ensures("\\result == of(Objects.requireNonNull(left, \"left\"), Objects.requireNonNull(right, \"right\"))")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
     ...
     */
    @com.jml.inferrer.annotations.Ensures("this.left == left")
    @com.jml.inferrer.annotations.Assignable("this.left")
     ...
     */
    @com.jml.inferrer.annotations.Ensures("this.right == right")
    @com.jml.inferrer.annotations.Assignable("this.right")
    @com.jml.inferrer.annotations.Mutator
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
