 ...
 * @since 2.0
 */
@com.jml.inferrer.annotations.Invariant("DEFAULT_NOT_NAN_EX_MESSAGE == \"The validated value is not a number\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_FINITE_EX_MESSAGE == \"The value is invalid: %f\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_EXCLUSIVE_BETWEEN_EX_MESSAGE == \"The value %s is not in the specified exclusive range of %s to %s\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_INCLUSIVE_BETWEEN_EX_MESSAGE == \"The value %s is not in the specified inclusive range of %s to %s\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_MATCHES_PATTERN_EX == \"The string %s does not match the pattern %s\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_IS_NULL_EX_MESSAGE == \"The validated object is null\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_IS_TRUE_EX_MESSAGE == \"The validated expression is false\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_NO_NULL_ELEMENTS_ARRAY_EX_MESSAGE == \"The validated array contains null element at index: %d\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_NO_NULL_ELEMENTS_COLLECTION_EX_MESSAGE == \"The validated collection contains null element at index: %d\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_NOT_BLANK_EX_MESSAGE == \"The validated character sequence is blank\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_NOT_EMPTY_ARRAY_EX_MESSAGE == \"The validated array is empty\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_NOT_EMPTY_CHAR_SEQUENCE_EX_MESSAGE == \"The validated character sequence is empty\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_NOT_EMPTY_COLLECTION_EX_MESSAGE == \"The validated collection is empty\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_NOT_EMPTY_MAP_EX_MESSAGE == \"The validated map is empty\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_VALID_INDEX_ARRAY_EX_MESSAGE == \"The validated array index is invalid: %d\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_VALID_INDEX_CHAR_SEQUENCE_EX_MESSAGE == \"The validated character sequence index is invalid: %d\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_VALID_INDEX_COLLECTION_EX_MESSAGE == \"The validated collection index is invalid: %d\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_VALID_STATE_EX_MESSAGE == \"The validated state is false\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_IS_ASSIGNABLE_EX_MESSAGE == \"Cannot assign a %s to a %s\"")
@com.jml.inferrer.annotations.Invariant("DEFAULT_IS_INSTANCE_OF_EX_MESSAGE == \"Expected type: %s, actual: %s\"")
...
public class Validate {
    ...
    @com.jml.inferrer.annotations.Requires("value > start && value < end")
    @com.jml.inferrer.annotations.Requires("value > start")
    @com.jml.inferrer.annotations.Requires("value < end")
    @com.jml.inferrer.annotations.Signals("IllegalArgumentException when value <= start || value >= end")
    ...
    @com.jml.inferrer.annotations.Requires("value.compareTo(start) > 0 && value.compareTo(end) < 0")
    @com.jml.inferrer.annotations.Requires("value instanceof Comparable")
    @com.jml.inferrer.annotations.Signals("IllegalArgumentException when value.compareTo(start) <= 0 || value.compareTo(end) >= 0")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
     ...
     */
    @com.jml.inferrer.annotations.Confidence(Confidence.Level.HIGH)
    @com.jml.inferrer.annotations.Signals("IllegalArgumentException when Double.isNaN(value) || Double.isInfinite(value)")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
    ...
    /**
     * Gets the message using {@link String#format(String, Object...) String.format(message, values)} if the values are not empty, otherwise return the message
     ...
     */
    @com.jml.inferrer.annotations.Confidence(Confidence.Level.HIGH)
    @com.jml.inferrer.annotations.Requires("superType != null")
    @com.jml.inferrer.annotations.Requires("type != null")
    @com.jml.inferrer.annotations.Signals("IllegalArgumentException when type == null || superType == null || !superType.isAssignableFrom(type)")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(2^n)", space = "O(log n)")
    ...
    @com.jml.inferrer.annotations.Confidence(Confidence.Level.HIGH)
    @com.jml.inferrer.annotations.Requires("superType != null")
    @com.jml.inferrer.annotations.Requires("superType.isAssignableFrom(type)")
    @com.jml.inferrer.annotations.Requires("type != null")
    @com.jml.inferrer.annotations.Signals("IllegalArgumentException when !superType.isAssignableFrom(type)")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(2^n)", space = "O(log n)")
    ...
    @com.jml.inferrer.annotations.Confidence(Confidence.Level.HIGH)
    @com.jml.inferrer.annotations.Requires("type != null")
    @com.jml.inferrer.annotations.Requires("type.isInstance(obj)")
    @com.jml.inferrer.annotations.Signals("IllegalArgumentException when !type.isInstance(obj)")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
     ...
     */
    @com.jml.inferrer.annotations.Confidence(Confidence.Level.HIGH)
    @com.jml.inferrer.annotations.Requires("expression")
    @com.jml.inferrer.annotations.Signals("IllegalArgumentException when !expression")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
     ...
     */
    @com.jml.inferrer.annotations.Confidence(Confidence.Level.HIGH)
    @com.jml.inferrer.annotations.Requires("messageSupplier != null")
    @com.jml.inferrer.annotations.Requires("expression")
    @com.jml.inferrer.annotations.Signals("IllegalArgumentException when !expression")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
     ...
     */
    @com.jml.inferrer.annotations.Requires("iterable instanceof Iterable<?>")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == noNullElements(iterable, DEFAULT_NO_NULL_ELEMENTS_COLLECTION_EX_MESSAGE)")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(2^n)", space = "O(log n)")
     ...
     */
    @com.jml.inferrer.annotations.Requires("iterable != null")
    @com.jml.inferrer.annotations.Requires("e != null")
    @com.jml.inferrer.annotations.Requires("iterable instanceof Iterable<?>")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    ...
    @com.jml.inferrer.annotations.Requires("array instanceof Iterable<?>")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == noNullElements(array, DEFAULT_NO_NULL_ELEMENTS_ARRAY_EX_MESSAGE)")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(2^n)", space = "O(log n)")
     ...
     */
    @com.jml.inferrer.annotations.Requires("array != null")
    @com.jml.inferrer.annotations.Requires("array[i] != null")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.LoopInvariant("i >= 0")
    @com.jml.inferrer.annotations.LoopInvariant("i <= array.length")
    @com.jml.inferrer.annotations.LoopInvariant("(\\forall int k; 0 <= k && k < i; array[k] != null)")
     ...
     * @since 3.0
     */
    @com.jml.inferrer.annotations.Requires("chars instanceof CharSequence")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == notBlank(chars, DEFAULT_NOT_BLANK_EX_MESSAGE)")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(2^n)", space = "O(log n)")
     ...
     * @since 3.0
     */
    @com.jml.inferrer.annotations.Requires("chars != null")
    @com.jml.inferrer.annotations.Requires("chars instanceof CharSequence")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
     ...
     */
    @com.jml.inferrer.annotations.Requires("collection instanceof Collection<?>")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == notEmpty(collection, DEFAULT_NOT_EMPTY_COLLECTION_EX_MESSAGE)")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(2^n)", space = "O(log n)")
     ...
     */
    @com.jml.inferrer.annotations.Requires("map instanceof Collection<?>")
    @com.jml.inferrer.annotations.Requires("map instanceof Map<?,?>")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == notEmpty(collection, DEFAULT_NOT_EMPTY_COLLECTION_EX_MESSAGE)")
    @com.jml.inferrer.annotations.Ensures("\\result == notEmpty(map, DEFAULT_NOT_EMPTY_MAP_EX_MESSAGE)")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(2^n)", space = "O(log n)")
     ...
     */
    @com.jml.inferrer.annotations.Requires("chars instanceof Collection<?>")
    @com.jml.inferrer.annotations.Requires("chars instanceof Map<?,?>")
    @com.jml.inferrer.annotations.Requires("chars instanceof CharSequence")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == notEmpty(collection, DEFAULT_NOT_EMPTY_COLLECTION_EX_MESSAGE)")
    @com.jml.inferrer.annotations.Ensures("\\result == notEmpty(map, DEFAULT_NOT_EMPTY_MAP_EX_MESSAGE)")
    @com.jml.inferrer.annotations.Ensures("\\result == notEmpty(chars, DEFAULT_NOT_EMPTY_CHAR_SEQUENCE_EX_MESSAGE)")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(2^n)", space = "O(log n)")
     ...
     * @see #notEmpty(Object[])
     */
    @com.jml.inferrer.annotations.Requires("collection != null")
    @com.jml.inferrer.annotations.Requires("collection instanceof Collection<?>")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("!(collection.isEmpty()) ==> \\result == collection")
    @com.jml.inferrer.annotations.Signals("IllegalArgumentException when collection.isEmpty()")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
     ...
     * @see #notEmpty(Object[])
     */
    @com.jml.inferrer.annotations.Requires("map != null")
    @com.jml.inferrer.annotations.Requires("map instanceof Map<?,?>")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("!(map.isEmpty()) ==> \\result == map")
    @com.jml.inferrer.annotations.Signals("IllegalArgumentException when map.isEmpty()")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
     ...
     */
    @com.jml.inferrer.annotations.Requires("chars != null")
    @com.jml.inferrer.annotations.Requires("chars.length() != 0")
    @com.jml.inferrer.annotations.Requires("chars instanceof CharSequence")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("chars.length() != 0 ==> \\result == chars")
    @com.jml.inferrer.annotations.Signals("IllegalArgumentException when chars.length() == 0")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
     ...
     */
    @com.jml.inferrer.annotations.Requires("array != null")
    @com.jml.inferrer.annotations.Requires("array.length() != 0")
    @com.jml.inferrer.annotations.Requires("array instanceof CharSequence")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("chars.length() != 0 ==> \\result == chars")
    @com.jml.inferrer.annotations.Ensures("\\result == notEmpty(array, DEFAULT_NOT_EMPTY_ARRAY_EX_MESSAGE)")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(2^n)", space = "O(log n)")
    ...
    @com.jml.inferrer.annotations.Requires("array.length != 0")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("array.length != 0 ==> \\result == array")
    @com.jml.inferrer.annotations.Signals("IllegalArgumentException when array.length == 0")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
     ...
     */
    @com.jml.inferrer.annotations.Confidence(Confidence.Level.HIGH)
    @com.jml.inferrer.annotations.Signals("IllegalArgumentException when Double.isNaN(value)")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
    ...
    @Deprecated
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == notNull(object, DEFAULT_IS_NULL_EX_MESSAGE)")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(2^n)", space = "O(log n)")
     ...
     */
    @com.jml.inferrer.annotations.Requires("object != null")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == object")
    @com.jml.inferrer.annotations.Ensures("\\result == Objects.requireNonNull(object, toSupplier(message, values))")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
    ...
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == (() -> getMessage(message, values))")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
    ...
    @com.jml.inferrer.annotations.Requires("collection instanceof Collection<?>")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == validIndex(collection, index, DEFAULT_VALID_INDEX_COLLECTION_EX_MESSAGE, Integer.valueOf(index))")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(2^n)", space = "O(log n)")
    ...
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == validIndex(collection, index, DEFAULT_VALID_INDEX_COLLECTION_EX_MESSAGE, Integer.valueOf(index))")
    @com.jml.inferrer.annotations.Ensures("\\result == validIndex(chars, index, DEFAULT_VALID_INDEX_CHAR_SEQUENCE_EX_MESSAGE, Integer.valueOf(index))")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(2^n)", space = "O(log n)")
     ...
     */
    @com.jml.inferrer.annotations.Requires("collection != null")
    @com.jml.inferrer.annotations.Requires("index >= 0 && index < collection.size()")
    @com.jml.inferrer.annotations.Requires("collection instanceof Collection<?>")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("!(index < 0 || index >= collection.size()) ==> \\result == collection")
    @com.jml.inferrer.annotations.Signals("IndexOutOfBoundsException when index < 0 || index >= collection.size()")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
     ...
     */
    @com.jml.inferrer.annotations.Requires("chars != null")
    @com.jml.inferrer.annotations.Requires("index >= 0 && index < chars.length()")
    @com.jml.inferrer.annotations.Requires("chars instanceof CharSequence")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("!(index < 0 || index >= chars.length()) ==> \\result == chars")
    @com.jml.inferrer.annotations.Signals("IndexOutOfBoundsException when index < 0 || index >= chars.length()")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
     ...
     */
    @com.jml.inferrer.annotations.Requires("array != null")
    @com.jml.inferrer.annotations.Requires("array >= 0 && array < chars.length()")
    @com.jml.inferrer.annotations.Requires("array instanceof CharSequence")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("!(index < 0 || index >= chars.length()) ==> \\result == chars")
    @com.jml.inferrer.annotations.Ensures("\\result == validIndex(array, index, DEFAULT_VALID_INDEX_ARRAY_EX_MESSAGE, Integer.valueOf(index))")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(2^n)", space = "O(log n)")
    ...
    @com.jml.inferrer.annotations.Confidence(Confidence.Level.HIGH)
    @com.jml.inferrer.annotations.Requires("array != null")
    @com.jml.inferrer.annotations.Requires("index >= 0 && index < array.length")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("!(index < 0 || index >= array.length) ==> \\result == array")
    @com.jml.inferrer.annotations.Signals("IndexOutOfBoundsException when index < 0 || index >= array.length")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
    ...
    @com.jml.inferrer.annotations.Confidence(Confidence.Level.HIGH)
    @com.jml.inferrer.annotations.Requires("expression")
    @com.jml.inferrer.annotations.Signals("IllegalStateException when !expression")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Observer
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
