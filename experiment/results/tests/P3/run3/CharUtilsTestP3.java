...
public class CharUtilsTestP3P3 {
    ...
    @Test
    void testCompare_EdgeCases_MinMaxChars() {
    ...
    void testIsAscii_AsciiChars() {
        ...
        assertTrue(CharUtils.isAscii('!'));
        assertTrue(CharUtils.isAscii('~')); // ASCII max
        assertTrue(CharUtils.isAscii('\0')); // ASCII min
    }
    ...
    void testIsAscii_NonAsciiChars() {
        ...
        assertFalse(CharUtils.isAscii('京'));
        assertFalse(CharUtils.isAscii('\u0080')); // First non-ASCII char
        assertFalse(CharUtils.isAscii('\u00FF')); // Last char in Latin-1 that's non-ASCII
    }
    ...
    void testIsAsciiAlpha_NonAlphaChars() {
        ...
        assertFalse(CharUtils.isAsciiAlpha('!'));
        assertFalse(CharUtils.isAsciiAlpha('@'));
        assertFalse(CharUtils.isAsciiAlpha('{')); // Just outside 'z'
        assertFalse(CharUtils.isAsciiAlpha('`')); // Just outside 'a'
        assertFalse(CharUtils.isAsciiAlpha('/')); // Just outside 'A'
        assertFalse(CharUtils.isAsciiAlpha('[')); // Just outside 'Z'
    ...
    void testIsAsciiNumeric_NonNumericChars() {
        ...
        assertFalse(CharUtils.isAsciiNumeric('!'));
        assertFalse(CharUtils.isAsciiNumeric('/')); // Just before '0'
        assertFalse(CharUtils.isAsciiNumeric(':')); // Just after '9'
    ...
    void testIsAsciiPrintable_PrintableChars() {
        ...
        assertTrue(CharUtils.isAsciiPrintable('~')); // Max printable ASCII
    }

    @Test
    void testIsAsciiPrintable_NonPrintableChars() {
        assertFalse(CharUtils.isAsciiPrintable('\0')); // NUL (control)
        assertFalse(CharUtils.isAsciiPrintable('\u001F')); // US (control)
        assertFalse(CharUtils.isAsciiPrintable('\u007F')); // DEL (control)
    ...
    @Test
    void testToChar_String_Whitespace() {
    ...
    void testToChar_StringWithDefault_MultipleChars() {
        ...
        assertEquals(' ', CharUtils.toChar("ab", ' '));
    }
    ...
    // --- toIntValue(char ch) ---
    @Test
    void testToIntValue_Char_NumericChar() {
    ...
    @Test
    void testToIntValue_Char_NonNumericChar() {
    ...
    @Test
    void testToIntValue_CharWithDefault_NumericChar() {
        assertEquals(0, CharUtils.toIntValue('0', 99));
        assertEquals(5, CharUtils.toIntValue('5', 99));
    }

    @Test
    void testToIntValue_CharWithDefault_NonNumericChar() {
    ...
    void testUnicodeEscaped_PrimitiveChar_NonAscii() {
        ...
        assertEquals("\\u20ac", CharUtils.unicodeEscaped('€'));
        assertEquals("\\u4eac", CharUtils.unicodeEscaped('京'));
    }
