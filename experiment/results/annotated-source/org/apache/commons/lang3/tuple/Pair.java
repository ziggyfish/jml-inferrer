...
@com.jml.inferrer.annotations.Invariant("serialVersionUID == 4954918890077093841L")
@com.jml.inferrer.annotations.Invariant("EMPTY_ARRAY == {}")
...
public abstract class Pair<L, R> implements Map.Entry<L, R>, Comparable<Pair<L, R>>, Serializable {
     ...
     */
    @com.jml.inferrer.annotations.Confidence(Confidence.Level.HIGH)
    @com.jml.inferrer.annotations.Requires("function != null")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == function.apply(getKey(), getValue())")
    @com.jml.inferrer.annotations.Signals("E")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    ...
    @Override
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == getLeft()")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
    ...
    @com.jml.inferrer.annotations.InheritedSpec(from = "Entry")
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result == getRight()")
    ...
    @com.jml.inferrer.annotations.Ensures("\\result == (Objects.hashCode(getKey()) ^ Objects.hashCode(getValue()))")
    ...
    @Override
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result.equals(\"(\" + getLeft() + ',' + getRight() + ')')")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
     ...
     */
    @com.jml.inferrer.annotations.Ensures("\\result != null")
    @com.jml.inferrer.annotations.Ensures("\\result.equals(String.format(format, getLeft(), getRight()))")
    @com.jml.inferrer.annotations.Assignable("\\nothing")
    @com.jml.inferrer.annotations.Pure
    @com.jml.inferrer.annotations.ThreadSafe
    @com.jml.inferrer.annotations.Complexity(time = "O(1)", space = "O(1)")
